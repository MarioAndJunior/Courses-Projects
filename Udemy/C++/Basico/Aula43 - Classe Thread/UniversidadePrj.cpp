...
public:
	void calculaMediaGeralGraduacao() {
		...
		if(qtde > 0){
			cout << "Médiga geral dos alunos da graduação: " << soma/qtde << endl;
		}
		else{
			cout << "Médiga geral dos alunos da graduação: 0.0" << endl;
		}
	}
	...
	void calculaMediaGeralPosGraduacao() {
		...
		if(qtde > 0){
			cout << "Médiga geral dos alunos da pós-graduação: " << soma/qtde << endl;
		}
		else{
			cout << "Médiga geral dos alunos da pós-graduação: 0.0" << endl;
		}
	}
